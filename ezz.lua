local Library = {}; do
    ...
    do
        ...
        if not isfile(Library.FolderName .. '/Utilities/Hue.png') then
            writefile(Library.FolderName .. '/Utilities/Hue.png', game:HttpGet(""));
        end;
        ...
        if not isfile(Library.FolderName .. '/Utilities/Shadow.png') then
            writefile(Library.FolderName .. '/Utilities/Shadow.png', game:HttpGet("http://www.roblox.com/asset/?id=18245826428"));
        end;
